...
def get_host_groups_from_cloud(inventory):
    ...
    if hasattr(inventory, 'extra_config'):
        ...
        if StrictVersion(sdk.version.__version__) >= StrictVersion("0.13.0"):
            list_args['fail_on_cloud_config'] = inventory.extra_config['fail_on_errors']
    else:
        use_hostnames = False
...
def parse_args():
    ...
    parser.add_argument('--cloud', default=os.environ.get('OS_CLOUD'), help='Cloud name (default: None')
